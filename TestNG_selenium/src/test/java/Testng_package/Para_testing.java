...
//        driver.manage().window().maximize();
	...
	public void eBay() {
		driver = new ChromeDriver();
		driver.get(
				"https://www.ebay.com/?gad_source=1&gad_campaignid=22873541418&gbraid=0AAAABA_ya85eTcZP0DpU80Luz-bor-SYc&gclid=CjwKCAjw7_DEBhAeEiwAWKiCC7iaiOU10UTjMpQZ7OH5ISETEyzGQHy8mnho1hj1JsNRUHREsKtnzxoCvioQAvD_BwE");
	...
	public void zerobank() throws InterruptedException {
		...
		Thread.sleep(3000);
		System.out.println("Zerobank -Thread ID : "+Thread.currentThread());
		driver.quit();
	}
